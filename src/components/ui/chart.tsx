/**
 * @fileoverview This file provides a set of reusable chart components built on top of Recharts.
 * It includes a ChartContainer, Tooltip, and Legend, all designed to integrate
 * seamlessly with the application's theme and style.
...
/**
 * A component that injects the dynamic styles for the chart based on the config.
 */
 ...
 * This allows matching the data from the chart with the configuration provided.
 * @param {ChartConfig} config - The chart configuration.
 * @param {unknown} payload - The payload object from Recharts.
