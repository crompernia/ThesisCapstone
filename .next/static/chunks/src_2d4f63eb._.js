    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditEmployeePage.useEffect": ()=>{
            const fetchInitialData = {
                "EditEmployeePage.useEffect.fetchInitialData": async ()=>{
                    setIsLoading(true);
                    try {
                        ...
                        if (employee) {
                            ...
                            if (employee.branch) {
                                const depts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$c0a150__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getDepartmentsForBranch"])(employee.branch);
                                setDepartments(depts);
                            }
                            if (employee.department) {
                                const pos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$196d43__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getPositionsForDepartment"])(employee.department);
                                setPositions(pos);
                            }
                        } else {
                            toast({
            ...
            }["EditEmployeePage.useEffect.fetchInitialData"];
            fetchInitialData();
        }
    }["EditEmployeePage.useEffect"], [
        params.id,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditEmployeePage.useEffect": ()=>{
            const fetchDepartments = {
                "EditEmployeePage.useEffect.fetchDepartments": async ()=>{
                    if (watchedBranch) {
                        const depts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$c0a150__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getDepartmentsForBranch"])(watchedBranch);
                        setDepartments(depts);
            ...
            }["EditEmployeePage.useEffect.fetchDepartments"];
            fetchDepartments();
        }
    }["EditEmployeePage.useEffect"], [
        watchedBranch,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditEmployeePage.useEffect": ()=>{
            const fetchPositions = {
                "EditEmployeePage.useEffect.fetchPositions": async ()=>{
                    if (watchedDepartment) {
                        const pos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$196d43__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getPositionsForDepartment"])(watchedDepartment);
                        setPositions(pos);
            ...
            }["EditEmployeePage.useEffect.fetchPositions"];
            fetchPositions();
        }
    }["EditEmployeePage.useEffect"], [
        watchedDepartment,
...
_s(EditEmployeePage, "ubDTJ/vVrXUsLLgsK7vYsQ4GKPo=", false, function() {
    return [
...
//# sourceMappingURL=src_2d4f63eb._.js.map