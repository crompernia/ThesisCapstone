...
"[project]/src/lib/data:e98507 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/data:fed03d [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/data:3276c2 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/data:aa97b1 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/data:420c1a [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$e98507__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:e98507 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$fed03d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:fed03d [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$3276c2__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:3276c2 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$aa97b1__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:aa97b1 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$420c1a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:420c1a [app-client] (ecmascript) <text/javascript>");
...
function EmployeeDataPage() {
    ...
    const fetchEmployees = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EmployeeDataPage.useCallback[fetchEmployees]": async ()=>{
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$e98507__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getEmployees"])();
            setEmployees(data);
        }
        ...
        "EmployeeDataPage.useEffect": ()=>{
            ...
            const fetchFilterData = {
                "EmployeeDataPage.useEffect.fetchFilterData": async ()=>{
                    const branchesData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$3276c2__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getBranches"])();
        ...
        "EmployeeDataPage.useEffect": ()=>{
            const fetchDepartments = {
                "EmployeeDataPage.useEffect.fetchDepartments": async ()=>{
                    if (selectedBranch) {
                        const depts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$aa97b1__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getDepartmentsForBranch"])(selectedBranch);
            ...
            const fetchPositions = {
                "EmployeeDataPage.useEffect.fetchPositions": async ()=>{
                    if (selectedDepartment) {
                        const pos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$420c1a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getPositionsForDepartment"])(selectedDepartment);
                        setPositions(pos);
                    } else {
                        setPositions([]);
                    }
    ...
    const handleDelete = async (id)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$fed03d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteEmployee"])(id);
        if (result) {
            toast({
                title: "Success",
...
//# sourceMappingURL=src_5ac9372e._.js.map