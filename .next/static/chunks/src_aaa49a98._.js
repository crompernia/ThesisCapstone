...
"[project]/src/lib/data:46b6a7 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$46b6a7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:46b6a7 [app-client] (ecmascript) <text/javascript>");
                ...
                "EditEmployeePage.useEffect.fetchInitialData": async ()=>{
                    ...
                    try {
                        const [employee, branchesData] = await Promise.all([
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$46b6a7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getEmployeeById"])(params.id),
                        ...
                        if (employee) {
                            ...
                            if (employee.branch) {
                                const depts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$078416__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getDepartmentsForBranch"])(employee.branch);
                                setDepartments(depts);
                            }
                            if (employee.department) {
                                const pos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$2132fa__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getPositionsForDepartment"])(employee.department);
                                setPositions(pos);
                            }
                        } else {
                            toast({
        ...
        "EditEmployeePage.useEffect": ()=>{
            const fetchDepartments = {
                "EditEmployeePage.useEffect.fetchDepartments": async ()=>{
                    if (watchedBranch) {
                        const depts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$078416__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getDepartmentsForBranch"])(watchedBranch);
                        setDepartments(depts);
            ...
            const fetchPositions = {
                "EditEmployeePage.useEffect.fetchPositions": async ()=>{
                    if (watchedDepartment) {
                        const pos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$2132fa__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getPositionsForDepartment"])(watchedDepartment);
                        setPositions(pos);
...
//# sourceMappingURL=src_aaa49a98._.js.map