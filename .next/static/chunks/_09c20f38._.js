...
"[project]/src/app/admin/branches/data:dd8be4 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$branches$2f$data$3a$dd8be4__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/admin/branches/data:dd8be4 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$branches$2f$data$3a$e33ea8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/admin/branches/data:e33ea8 [app-client] (ecmascript) <text/javascript>");
...
function BranchesPage() {
    ...
    const fetchBranches = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BranchesPage.useCallback[fetchBranches]": async ()=>{
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$5971b8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getBranches"])();
            setBranches(data);
        }
    ...
    const handleAddBranch = async ()=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$branches$2f$data$3a$dd8be4__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createBranchAction"])(newBranchName);
        if (result.success) {
            toast({
                title: 'Success',
    ...
    const handleDeleteBranch = async (id)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$branches$2f$data$3a$e33ea8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteBranchAction"])(id);
        if (result.success) {
            toast({
                title: 'Success',
...
_s(BranchesPage, "GH5g6f/nCIQPB3+QKVyaveCxwqg=", false, function() {
    return [
...
//# sourceMappingURL=_09c20f38._.js.map